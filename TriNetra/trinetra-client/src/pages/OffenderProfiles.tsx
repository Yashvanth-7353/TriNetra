...
export default function OffenderProfiles() {
  ...
  const loadOffenders = async () => {
    ...
    setError('');
    try {
      const response = await fetchOffendersList(searchTerm || undefined, page, pageSize, sortKey, sortOrder);
                          ...
                          <div className="flex flex-col gap-4 max-w-4xl">
                            ...
                            <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-xs flex flex-col gap-4">
                              ...
                              <div className="text-sm text-slate-600 leading-relaxed">
                                ...
                                <strong className={scoreColorClass}>{offender.score.toFixed(0)}</strong>{' '}
