        ...
        <section className="px-6 py-24 bg-slate-50 border-y border-slate-100">
          <div className="max-w-4xl mx-auto">
            <div className="flex items-center gap-4 mb-8">
              ...
              <h2 className="text-3xl font-bold text-primary-900 uppercase tracking-widest text-center">The Mandate</h2>
              <div className="h-px bg-accent-500 flex-1"></div>
            </div>
            ...
            <div className="prose prose-lg max-w-none text-slate-700 space-y-6 bg-white p-8 md:p-12 rounded-2xl shadow-sm border border-slate-200">
              ...
              <p className="leading-relaxed">
                The solution enables users to discover hidden relationships between crimes, offenders, victims, and locations, support investigative decision making, and provide predictive and preventive insights to strengthen proactive law enforcement.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                { title: "Prevention Alerts", icon: Bell, desc: "Dynamic early warning warning alerts computed automatically for the logged-in officer's jurisdiction." }
              ].map((feature, i) => (
